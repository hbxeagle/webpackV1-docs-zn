...
* [`apply`](https://github.com/mogelbrod/apply-loader): Executes an exported JavaScript function, optionally with arguments, and exports its return value.
...
* [`substitute`](https://github.com/martinkr/substitute-loader): Emits a module whose content is substituted (default: ```null```, custom as parameter)
...
* [`glsl-template`](https://github.com/yuri-karadzhov/glsl-template-loader): Loads glsl shader files. Support #include directive and template variables.
...
* [`base64-inline`](https://github.com/monolithed/base64-inline-loader): Loader supports the most popular file extensions and can be injected directly into a file as base64 string.
...
* [`icon-maker`](https://github.com/unimonkiez/icon-maker-loader): Load SVG and bundle it to font and css, returns the class string to use that icon.
...
* [`image-maxsize`](https://github.com/shekhei/image-maxsize-webpack-loader): resize images to fit maximum width/height dimensions while retaining their aspect ratio.
* [`base64-image`](https://www.npmjs.com/package/base64-image-loader): Load image as base64 string src
* [`imgin`](https://github.com/jali-ai/imgin-loader): Generate placeholder images with different size, colors, text and font size.
...
* [`less-vars`](https://www.npmjs.com/package/less-vars-loader): Extracts variables from a given less file and returns it as JSON.
* [`await`](https://www.npmjs.com/package/await-loader): Like `promise-loader`, but simpler. Wraps request in a `require.ensure` block (promise).
...
* [`ion`](https://github.com/ion-lang/loader): Loads [ion](https://github.com/ion-lang/ion) files and compiles them to JavaScript.
* [`json-files-merge`](https://github.com/dsebastien/json-files-merge-loader): Loads and merges JSON files for inclusion in bundles (useful JSON-based i18n/config merging)
...
* [`rails-erb`](https://github.com/usabilityhub/rails-erb-loader): Compiles ERB files using Ruby on Rails
...
* [`mjml-with-images`](https://github.com/nodkz/mjml-with-images-loader): Compiles MJML files with images to responsive email HTML.
* [`webcomponents`](https://github.com/Roba1993/webcomponents-loader): Loads html webcomponents with some additional features. 
